...
{
    // https://referencesource.microsoft.com/#System.ComponentModel.DataAnnotations/DataAnnotations/Validator.cs
    public static class Validator
    {
        ...
        private static void EnsureValidPropertyType(string propertyName, Type propertyType, object value)
        {
            ...
            {
                throw new ArgumentException(String.Format(System.Globalization.CultureInfo.CurrentCulture, DataAnnotationsResources.Validator_Property_Value_Wrong_Type, propertyName, propertyType), "value");
            }
        }
